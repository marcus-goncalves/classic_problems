...
import sys
sys.path.insert(0, '..')
from chapter2.c2_generic_search import bfs, Node, node_to_path
...
class Graph(Generic[V]):
    ...
    def add_edge_by_vertices(self, first: V, second: V) -> None:
        ...
        self.add_edge_by_indices(_from, _to)
    ...
    def neighbors_for_index(self, index: int) -> List[V]:
        return list(map(self.vertex_at, [e.vertex_to for e in self._edges[index]]))
